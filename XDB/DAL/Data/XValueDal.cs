...
namespace XDB.DAL
{
    ...
    internal class XValueDal : XBaseDal
    {

        public XValueDal() : base(ECommonObjectType.XObject) { }
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        internal XValue Get(Guid id)
        {
            return this.PropertyValue_Get(id, StoredProcs.PropertyValue_Get);
        }

        internal Guid AssetId(Guid propertyValueId)
        {
        ...
        private XValue PropertyValue_Get(Guid propertyValueId, string spName)
        {
        ...
        internal string PopulateDisplayValue(string propertyValue, XProperty prop)
        {
        ...
        private string PopulateDisplayValueHtml(XValue propertyValue, XProperty prop)
        {
                    ...
                    if (prop != null)
                    {
                        switch (prop.DataType)
                        {
                            ...
                            case EDataType.Currency:
                                ...
                                XMoney cv = new XMoneyDal().Get(new Guid(propertyValue.Value));
                                if (cv != null)
                                {
                            ...
                            case EDataType.System_AssetType:
                                return string.Empty;
                            case EDataType.URL:
                                XUrl url = new XUrlDal().Get(new Guid(propertyValue.Value));
                                if (url != null)
                                {
                                    if (string.IsNullOrEmpty(url.Name))
                                    {
        ...
        /// <returns></returns>
        internal bool PropertyValue_Delete(Guid assetId, Guid propertyId, Guid userId)
        {
        ...
        private bool PropertyValue_Exists(Guid propertyId, Guid assetId, string value, bool isCaseSensitive)
        {
        ...
        internal bool Save(XValue propVal)
        {
            List<SqlParameter> paramList = new List<SqlParameter>
                {
            ...
            return base.ExecuteSql(StoredProcs.PropertyValue_Save, paramList);
        }
        ...
        /// <returns></returns>
        internal bool PropertyValue_Save(XValue propVal, bool deleteExisting, bool checkExistingIsCaseSensitive)
        {
        ...
        internal bool Delete(Guid id, Guid userId)
        {
            ...
            return base.ExecuteSql(StoredProcs.PropertyValue_Delete, paramList);
        ...
        /// <returns></returns>
        internal XValue Get(Guid propertyId, Guid assetId)
        {
            // TODO: Test this code
        ...
        internal XValue GetPrevious(Guid propertyId, Guid assetId)
        {
        ...
        internal bool PropertyValueList_Save(List<XValue> propertyvalueList, Dictionary<Guid, XProperty> properties)
        {
        ...
        private string FormatPropertyValue(XProperty prop, string value)
        {
        ...
        internal List<string> PropertyValues_GetPotentialByAssetTypeIds(List<Guid> assetTypeIds, ESystemType systemType)
        {
