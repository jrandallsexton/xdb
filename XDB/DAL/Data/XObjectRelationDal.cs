...
namespace XDB.DAL
{
    internal class XObjectRelationDal : XSqlDal
    {

        public XObjectRelationDal() { }
        ...
        internal bool AssetAssetRelationExists(Guid fromId, Guid toId, int relationTypeId)
        {
        ...
        internal bool RemoveExistingParentRelations(Guid fromId, int relationTypeId)
        {
            StringBuilder sql = new StringBuilder();
        ...
        internal XObjectRelation Get(Guid Id)
        {
        ...
        internal bool Save(XObjectRelation relation)
        {
        ...
        internal bool Save(List<XObjectRelation> relations)
        {
        ...
        internal List<XObjectRelation> AssetRelationList_GetByFromAssetId(Guid fromassetid)
        {
        ...
        internal bool AssetAssetRelationList_DeleteByFromAssetId(Guid FromAssetId)
        {
