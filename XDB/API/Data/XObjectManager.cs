...
namespace XDB.API
{
    ...
    public class XObjectManager : XBaseApi
    {

        public XObjectManager() : base(ECommonObjectType.XObject) { }

        XObjectLayer bizLayer = new XObjectLayer();

        private static XObjectManager instance;

        public static XObjectManager Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = new XObjectManager();
                }
                return instance;
            }
        }
        ...
        private void Validate(XObject asset)
        {
            ...
            if (!XObjectTypeManager.Instance.ValidId(asset.AssetTypeId))
            {
