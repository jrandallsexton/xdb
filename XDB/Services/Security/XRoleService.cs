...
namespace XDB.API
{
    ...
    public class XRoleService : XBaseService
    {

        public XRoleService() : base(ECommonObjectType.XRole) { }

        private XRoleLayer bizLayer = new XRoleLayer();

        private static XRoleService instance;
        public static XRoleService Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = new XRoleService();
                }
                return instance;
            }
        }
