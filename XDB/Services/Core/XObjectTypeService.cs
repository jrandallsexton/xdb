...
namespace XDB.API
{
    ...
    public class XObjectTypeService : XBaseService
    {

        public XObjectTypeService() : base(ECommonObjectType.XObjectType) { }

        private static XObjectTypeService instance;

        public static XObjectTypeService Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = new XObjectTypeService();
                }
                return instance;
            }
        }
