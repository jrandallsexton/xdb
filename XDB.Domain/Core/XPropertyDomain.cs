...
namespace XDB.Domains
{
    ...
    /// </summary>
    internal class XPropertyDomain : XBaseDomain
    {

        private XPropertyRepository<XProperty> dal = new XPropertyRepository<XProperty>();

        public XPropertyDomain() : base(ECommonObjectType.XProperty) { }
        ...
        public void Delete(Guid propertyId, Guid userId)
        {
            ...
            this.dal.Delete(propertyId, userId);
        }
        ...
        //public IDictionary<Guid, string> GetDictionary(bool includeDeleted, bool includeUnapproved)
        //{
        ...
        //public IDictionary<Guid, string> GetDictionaryByAssetTypeId(Guid assetTypeId,
