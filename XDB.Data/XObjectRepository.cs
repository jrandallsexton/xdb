...
namespace XDB.Repositories
{
    ...
    public class XObjectRepository<T> : XBaseDal, IXObjectRepository<T> where T : XBase, IXObject
    {
        ...
        public Guid? Asset_GetId(string assetName, Guid assetTypeId)
        {
            List<SqlParameter> paramList = new List<SqlParameter>
                {
        ...
        public IList<Guid> AssetIds_Get(string assetName, IList<Guid> assetTypeIdsToSearch)
        {
            StringBuilder sql = new StringBuilder();
        ...
        public bool Asset_Rename(Guid assetId, string newName)
        {
