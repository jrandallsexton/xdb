...
namespace XDB.Repositories
{
    ...
    public class XSubmittalRepository : XSqlDal
    {

        #region Constructors

        public XSubmittalRepository() { }

        public XSubmittalRepository(string connString) { this.ConnectionString = connString; }
        ...
        public XSubmittal PropertyValueSubmittal_Get_IgnoreDeletedFlag(Guid id)
        {
        ...
        /// <returns></returns>
        public bool PropertyValueSubmittal_Delete(Guid assetId, Guid propertyId, Guid userId)
        {
        ...
        public bool PropertyValueSubmittal_Delete(Guid id, Guid userId)
        {
        ...
        public List<XSubmittalHelper> SubmittalActivity_GetForAdmin(int maxItems)
        {
        ...
        public List<XSubmittalHelper> SubmittalActivity_GetByRoleMembership(string innerViewSelect, int maxItems)
        {
        ...
        public XNarrativeHelper CreateHelper(Guid submittalId)
        {
            StringBuilder sql = new StringBuilder();
        ...
        public bool SetNarrative(Guid submittalId, string narrative)
        {
